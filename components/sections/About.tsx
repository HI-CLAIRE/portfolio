      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <FadeInSection delay={0.1} direction="left">
            <div className="space-y-5 leading-relaxed" style={{ color: "var(--text-2)" }}>
          ...
          <FadeInSection delay={0.2} direction="right">
            <h3 className="text-lg font-semibold mb-6" style={{ color: "var(--text-1)" }}>
              {t.about.careerLabel}
            </h3>
              ...
              <ul className="space-y-6">
                {t.about.timeline.map((item, i) => (
                  <li key={i} className="pl-10 relative">
                    ...
                    <div
                      className="glass-card rounded-xl p-4 hover:border-purple-500/20 transition-colors duration-200"
                    >
                      <span className="text-xs text-purple-400 font-mono">{item.period}</span>
